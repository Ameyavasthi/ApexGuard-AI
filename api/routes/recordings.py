"""api/routes/recordings.py — Video Clip Serving with HTTP Range Support

Chrome REQUIRES byte-range requests to play video inline.
Without range support the browser sends a Range: bytes=0- header and
if the server ignores it and responds 200 instead of 206, Chrome
treats the stream as unseekable and shows a black player at 0:00.
"""
import os
import re
